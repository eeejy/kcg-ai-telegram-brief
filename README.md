...
> ### 📄 [**이게 무엇이고 어떻게 도는지 — 설명자료 보기**](https://htmlpreview.github.io/?https://raw.githubusercontent.com/eeejy/kcg-ai-telegram-brief/main/docs/%EC%84%A4%EB%AA%85%EC%9E%90%EB%A3%8C.html)
> 쉬운 말로 정리했습니다. 무엇을 하는지, 어디서 도는지, 어떤 도구와 계정을 쓰는지,
> 비용과 키는 어떻게 되는지 담았습니다.

> **알림** — 현재 **개인 GitHub 계정**으로 운영하고 있습니다.
> 기관 계정으로 옮기려면 저장소만 옮기면 되고, 코드는 그대로 씁니다.
> AI는 쓰지 않으며, 전체 비용이 들지 않습니다.

해양경찰 AI팀이 알아야 할 공개 뉴스를 수집해 월~금 오전 08:00(Asia/Seoul)에 Telegram 채널로 전송하는 무과금 최소 기능 프로젝트입니다.

## 브리핑 구성

주간 동향지와 같은 관점으로 나눕니다 — 무슨 기술이냐가 아니라 우리 업무와 얼마나 가까우냐입니다.

1. ⚓ 우리청·해양
2. 🚨 유사·인접기관 (경찰청·소방청·해양수산부)
3. 🏛️ 범정부 AI 정책
4. 🏢 타 기관 도입사례
5. 🔥 산업·기술 동향
